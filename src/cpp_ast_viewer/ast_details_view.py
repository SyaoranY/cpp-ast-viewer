...
class AstDetailsView(QTreeWidget):
  ...
  def _add_type_group(self, cursor: Cursor):
    ...
    self._add_property(group, "Underlying typedef type", self._safe(lambda: cursor.underlying_typedef_type.spelling))
  ...
  def _add_cpp_group(self, cursor: Cursor):
    ...
    self._add_property(group, "Exception specification", self._safe(lambda: cursor.exception_specification_kind.name))
  ...
  def _add_argument_group(self, cursor: Cursor):
    ...
    for index, argument in enumerate(arguments):
      ...
      self._add_property(arg_item, "Location", self._safe(lambda arg=argument : self._format_location(arg.location)))
  ...
  def _add_token_group(self, cursor: Cursor):
    ...
    for index, token in enumerate(tokens):
      ...
      self._add_property(token_item, "Location", self._safe(lambda tok=token : self._format_location(tok.location)))
